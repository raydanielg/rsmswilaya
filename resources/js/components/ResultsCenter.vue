                  ...
                  <ul class="space-y-2">
                    <li v-for="doc in (list[year] || [])" :key="doc.url" class="flex items-center justify-between border border-gray-200 rounded-md p-3">
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        <a v-if="!isExternal(doc.url)" :href="doc.url" :download="filenameFromUrl(doc.url)" class="px-3 py-1.5 rounded-lg text-white bg-primary-700 hover:bg-primary-800">Download</a>
                        <a v-else :href="doc.url" target="_blank" rel="noopener" class="px-3 py-1.5 rounded-lg text-white bg-primary-700 hover:bg-primary-800">Download</a>
                      </div>
                    </li>
